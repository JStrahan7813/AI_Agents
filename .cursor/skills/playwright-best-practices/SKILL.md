...
| **Initializing a new Playwright project** | [test-setup.md](references/test-setup.md)                                                                                                            |
...
| **Creating/initializing Playwright test environment** | [test-setup.md](references/test-setup.md)                                                                          |
...
│  ├─ New Playwright project / test environment → test-setup.md
│  ├─ CI/CD → ci-cd.md
